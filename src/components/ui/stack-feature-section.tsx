...
export default function FeatureSection() {
  ...
  return (
    <section className="relative max-w-6xl mx-auto my-16 pl-4 md:pl-10 flex items-center justify-between h-[30rem] border border-gray-200 dark:border-gray-700 bg-white dark:bg-black overflow-hidden rounded-3xl">
      <div className="w-1/2 z-10">
        ...
        <p className="text-gray-500 dark:text-gray-300 mb-6 max-w-lg">
          Nexus AI is a modern platform for AI-powered development, design, and innovation.
        </p>
